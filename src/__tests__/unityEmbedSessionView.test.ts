...
describe("Unity embedded session view", () => {
  ...
  it("bridges Unity asset drops into the embedded composer attachment bar", () => {
    ...
    expect(unityWindow).toContain('ConsoleTextEntryDto');
    expect(unityWindow).toContain('ConsoleTextControlMessage');
    expect(unityWindow).toContain('SendConsoleTextEntries(');
    expect(unityWindow).toContain('SendConsolePayload(');
    expect(unityWindow).toContain('[MenuItem("Window/Locus Console/Send All to Locus", false, 100)]');
    expect(unityWindow).toContain('[MenuItem("Window/Locus Console/Send Selected to Locus", false, 101)]');
    expect(unityWindow).toContain('[MenuItem("Window/Locus Console/Send Selected to Locus %&c", false, 102)]');
    expect(unityWindow).toContain('[MenuItem("Window/Locus Console/Show Console Toolbar", false, 200)]');
    expect(unityWindow).toContain('[MenuItem("Window/Locus Console/Hide Console Toolbar", false, 201)]');
    expect(unityWindow).toContain('LocusConsoleToolbarWindow.ShowToolbar()');
    expect(unityWindow).toContain('LocusConsoleToolbarWindow.HideToolbar()');
    expect(unityWindow).toContain('ConsoleToolbarButtonLabel');
    expect(unityWindow).toContain('type = "consoleText"');
    expect(unityWindow).toContain('ConsoleShortcutHint');
    const consoleIntegration = read("locus_unity/Editor/LocusConsoleIntegration.cs");
    const consoleToolbar = read("locus_unity/Editor/LocusConsoleToolbarWindow.cs");
    expect(consoleToolbar).toContain("internal sealed class LocusConsoleToolbarWindow : EditorWindow");
    expect(consoleToolbar).toContain("ShowUtility()");
    expect(consoleToolbar).toContain("public static LocusConsoleToolbarWindow ShowToolbar()");
    expect(consoleToolbar).toContain("public static void HideToolbar()");
    expect(consoleToolbar).toContain("public static bool IsToolbarOpen()");
    expect(consoleToolbar).toContain("LocusConsoleIntegration.SendSelectedToLocus()");
    expect(consoleToolbar).toContain("LocusConsoleIntegration.SendAllToLocus()");
    expect(consoleToolbar).toContain("Resources.FindObjectsOfTypeAll");
    expect(consoleToolbar).toContain("RepositionToConsole");
    expect(consoleToolbar).not.toContain("m_ListView");
    expect(consoleToolbar).not.toContain("selectedItems");
    expect(consoleIntegration).toContain("[InitializeOnLoad]");
    expect(consoleIntegration).toContain("internal static class LocusConsoleIntegration");
    expect(consoleIntegration).toContain("public static void SendAllToLocus()");
    expect(consoleIntegration).toContain("public static void SendSelectedToLocus()");
    expect(consoleIntegration).toContain("HandleLocusConsoleSendButtonMouseDown");
    expect(consoleIntegration).toContain("BuildConsoleTextPayloadJsonForSelection");
    expect(consoleIntegration).toContain("selectedItems");
    expect(consoleIntegration).toContain("m_ListView");
    expect(consoleIntegration).toContain("SendConsoleTextEntries(");
    expect(consoleIntegration).toContain("unity-console-selected");
    expect(consoleIntegration).not.toContain('text = "Send to Locus"');
    expect(consoleIntegration).not.toContain("ConsoleWindow.docked");
    ...
    expect(consoleBridge).toContain("BuildConsoleTextPayloadJsonForSelection");
    expect(consoleBridge).toContain("TryBuildConsoleTextEntriesFromLogEntries");
    expect(consoleBridge).toContain("ResolveTargetEntryIndices");
    expect(consoleBridge).toContain("AddConsoleEntry");
    expect(consoleBridge).toContain("ConvertMemberToInt");
    expect(consoleBridge).toContain("ConsoleSourceAll");
    expect(consoleBridge).toContain("ConsoleSourceSelected");

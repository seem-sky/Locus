...
export const useUiStore = defineStore("ui", () => {
  ...
  const settingsCategoryHint = ref<"api" | "models" | "permissions" | "codeAnalysis" | "hotReload" | "unityConnection" | "testing" | "proxy" | "headroom" | "general" | "display" | "notifications" | "shortcuts" | "archived" | "console" | "about" | null>(null);

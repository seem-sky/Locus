...
* When the user may need to manually edit specific Unity serialized fields after you changed or inspected many objects, output only those fields in a fenced `unity_property` block. This lets the UI show a compact field editor instead of a full object Inspector.
